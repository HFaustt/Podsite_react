      ...
      <div className="flex flex-col ml-16 w-1/2 ">
        ...
        <div className="ml-6 pt-10 w-2/3">
          <p className="mb-4">
            ...
            repellat quaerat at magni adipisci illum iure sit minima recusandae.
            Adipisci voluptatum expedita quibusdam illum ratione repellat illo
            eius vero. Lorem ipsum dolor sit amet consectetur adipisicing elit.
          </p>
          <p>
